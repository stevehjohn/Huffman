...
Executing code in Release build configuration on an AWS t2.micro instance that has no other workload.
...
Uncompressed file size: 792,968 bytes.
Compressed file size:   454,568 bytes.
...
Filename: Frankenstein or the Modern Prometheus

Uncompressed file size: 448,844 bytes.
...
Uncompressed file size: 1,035,187 bytes.
Compressed file size:   595,235 bytes.
...
Filename: Les Misérables

Uncompressed file size: 3,325,127 bytes.
...
Uncompressed file size: 790,334 bytes.
Compressed file size:   432,705 bytes.
...
Filename: War of the Worlds

Uncompressed file size: 363,744 bytes.
