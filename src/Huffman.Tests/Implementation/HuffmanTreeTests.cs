...
//        private static IEnumerable<StringFrequency> GetFrequencies()
//        {
//            return new[]
//                   {
//                       new StringFrequency { Frequency = 4, Character = 'e' },
//                       new StringFrequency { Frequency = 4, Character = 'a' },
//                       new StringFrequency { Frequency = 7, Character = ' ' },
//                       new StringFrequency { Frequency = 2, Character = 'n' },
//                       new StringFrequency { Frequency = 2, Character = 't' },
//                       new StringFrequency { Frequency = 2, Character = 'm' },
//                       new StringFrequency { Frequency = 2, Character = 'i' },
//                       new StringFrequency { Frequency = 2, Character = 'h' },
//                       new StringFrequency { Frequency = 2, Character = 's' },
//                       new StringFrequency { Frequency = 3, Character = 'f' },
//                       new StringFrequency { Frequency = 1, Character = 'o' },
//                       new StringFrequency { Frequency = 1, Character = 'u' },
//                       new StringFrequency { Frequency = 1, Character = 'x' },
//                       new StringFrequency { Frequency = 1, Character = 'p' },
//                       new StringFrequency { Frequency = 1, Character = 'r' },
//                       new StringFrequency { Frequency = 1, Character = 'l' }
//                   };
//        }
//    }
//}